describe Noths::Checkout do
  let(:item_1) { Noths::Item.new price: 925,  product_code: "001", name: "Travel Card Holder"     }
  let(:item_2) { Noths::Item.new price: 4500, product_code: "002", name: "Personalised cufflinks" }
  let(:item_3) { Noths::Item.new price: 1995, product_code: "003", name: "Kids T-shirt"           }
